  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        primary: "bg-slate-600 border-slate-800 text-white border-b-4 active:border-b-2 hover:bg-lightblue",
        outline: "bg-white text-blue position-y-2 border-blue border-2 border-b-4 active:border-b-2 hover:bg-[#EDF7FF] hover:border-b-4",
        secondary: "bg-green text-white position-y-2 border-darkgreen border-b-4 hover:bg-lightgreen active:border-b-2",
        tertiary:"bg-[#DAF322] text-[#58690D] position-y-2 border-[#A5C41B] border-b-4 hover:bg-[#E3F93C] active:border-b-2",
        quaternary:"bg-[#30D2FF] text-[#095491] position-y-2 border-[#1E97D4] border-b-4 hover:bg-[#53DAFF] active:border-b-2",
